...
<font size="8" color="red">Please select from below options</font>
			        ...
			        <form class = 'submit-button' method = 'post' action = 'ManageBook.jsp'>                  		 			           
			         ...
			         <form class = 'submit-button' method = 'post' action = 'ManageBook.jsp'>                  		 			           
			            <input class = 'submit-button' type = 'submit'  value = 'Update Books' style="margin-left: 45px; width: 500px; height: 50px;"/>
			            <input type='hidden' name = 'BookFunction' value = 'UpdateBook' />
			        </form>
			        
			         <form class = 'submit-button' method = 'post' action = 'ManageBook.jsp'>                  		 			           
			            <input class = 'submit-button' type = 'submit'  value = 'Delete Books' style="margin-left: 45px; width: 500px; height: 50px;"/>
			            <input type='hidden' name = 'BookFunction' value = 'DeleteBook' />
			        </form>
